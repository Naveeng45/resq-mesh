...
Build the deterministic world-state used by the planner.

## Concepts to Learn

- Separate facts from reasoning.
- Model resources and capabilities explicitly.
- Learn availability, capacity, location, reliability, and status fields.

## Step-by-Step Implementation

1. Define `Resource` and `Capability` models.
2. Create a small synthetic resource inventory.
3. Add availability and status.
4. Add capacity where relevant.
5. Add deterministic query functions.
6. Add a tool that retrieves resources by required capability.
7. Test unavailable resources are excluded.
8. Keep resource facts outside prompts.
9. Add synthetic-data labeling.
10. Document assumptions.

## Expected Result

The system can query a clean, deterministic resource catalog using structured mission needs.
...
```text
Lesson completed: 04 — Resource Catalog
...
This is **Lesson 04: Resource Catalog**.
